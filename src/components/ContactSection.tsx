...
const contacts = [
  {
    icon: Mail,
    label: "bharatibhat39@gmail.com",
    href: "mailto:bharatibhat39@gmail.com",
  },
  {
    icon: Phone,
    label: "+91 8277333157 / 8431289243",
    href: "tel:8277333157",
  },
  {
    icon: Linkedin,
    label: "LinkedIn",
    href: "https://linkedin.com/in/bharati-bhat-418483329",
  },
  {
    icon: Github,
    label: "GitHub",
    href: "https://github.com/Bharatibhat07",
  },
  {
    icon: Instagram,
    label: "Instagram",
    href: "https://instagram.com/bharati_bhat_07",
  },
];


// FIXED: Uses Render backend instead of Vite proxy
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4">
        ...
        <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4 neon-text">
          Get In Touch
        </h2>
        ...
        <div className="flex flex-col lg:flex-row gap-12 max-w-5xl">
          ...
          >
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-lg bg-muted border border-glass-border resize-none"
